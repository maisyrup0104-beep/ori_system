        ...
        <div className="space-y-8">
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
              <MetricCard
                label="Revenue Goal"
                value={settings?.revenue_goal ? `₱${settings.revenue_goal.toLocaleString('en-PH')}` : '—'}
                icon={DollarSign}
              />
              <MetricCard
                label="Current Revenue"
                value={settings?.current_revenue ? `₱${settings.current_revenue.toLocaleString('en-PH')}` : '—'}
                icon={TrendingUp}
              />
              <MetricCard
                label="Revenue Remaining"
                value={`₱${revenueRemaining.toLocaleString('en-PH')}`}
                icon={DollarSign}
              />
              <MetricCard
                label="Days Left"
